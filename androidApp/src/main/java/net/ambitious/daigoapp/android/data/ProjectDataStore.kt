...
class ProjectDataStore(context: Context) {
    ...
    companion object {
        ...
        private var dataStore: ProjectDataStore? = null
        fun getDataStore(context: Context) = dataStore ?: ProjectDataStore(context).also { dataStore = it }
    }
